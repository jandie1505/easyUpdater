...
programdirectory = "./"
executeableprogramfile = "./executable.bat" #Path to the executable File which will be executed after the updater finished.
...
print("STEP 1..." end=" ")
wget.download(onlineversionfile, "online-version.txt")
print("COMPLETE")
#Step 2: Read the local ONLINE VERSIONFILE
print("STEP 2..." end=" ")
f=open("online-version.txt", "r")
online-version = int(f.read())
f.close()
print("COMPLETE")
#Step 3: Overwrite the local ONLINE VERSIONFILE.
print("STEP 3..." end=" ")
f=open("online-version.txt", "w+")
f.write("0")
f.close()
print("COMPLETE")
